...
* [manuals](manuals) contains documentation detailing the Raspberry Pi implementation and usage.
...
* [monitor](monitor) contains an implementation script [monitor_run.py](monitor_run.py) which imports YOLOv5 via [PyTorch Hub](https://pytorch.org/hub/ultralytics_yolov5/) and runs inference based on a webcam input. There are also various pre-filtering stages based on the [ViBe](https://ieeexplore.ieee.org/document/5672785) background subtraction algorithm, which is implemented in this folder.
